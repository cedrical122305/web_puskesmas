...
$query = mysqli_query($conn, "SELECT * FROM tb_kadaluarsa
    LEFT JOIN tb_daftar_obat ON tb_daftar_obat.id = tb_kadaluarsa.nm_obat
    LEFT JOIN tb_batch AS batch1 ON batch1.id_batch = tb_kadaluarsa.batch
    LEFT JOIN tb_batch AS batch2 ON batch2.id_batch = tb_kadaluarsa.tgl_produksi
    LEFT JOIN tb_batch AS batch3 ON batch3.id_batch = tb_kadaluarsa.tgl_expired
    LEFT JOIN tb_status ON tb_status.id_status = tb_kadaluarsa.status_obat");
